<x-app-layout>
    <div class="container mx-auto p-6">
        ...
        <div class="mb-4">
                ...
                <div class="bg-white px-6 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-8">
                    <dt class="text-base font-semibold text-gray-700">1. Intervensi</dt>
                    <dd class="mt-1 text-base text-gray-900 sm:col-span-2 sm:mt-0">{{ $catins->intervensi1 ?? '-' }}</dd>
                </div>
                <div class="bg-white px-6 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-8">
                    <dt class="text-base font-semibold text-gray-700">2. Intervensi</dt>
                    <dd class="mt-1 text-base text-gray-900 sm:col-span-2 sm:mt-0">{{ $catins->intervensi2 ?? '-' }}</dd>
                </div>
                <div class="bg-gray-50 px-6 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-8">
